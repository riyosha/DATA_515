...
class TestRoastGenerator(unittest.TestCase):
    ...
    def test_generate_funny_roast_success(self, mock_print, mock_exists, mock_read_csv, mock_GenerativeModel):
        """
        ...
        mock_GenerativeModel.return_value = dummy_model
    ...
    def test_generate_funny_roast_reviews_file_missing(self, mock_print, mock_read_csv):
        ...
        generate_funny_roast("dummyuser", "dummy_api_key")
        mock_print.assert_any_call("Error: Could not find file 'dummyuser_reviews.csv'. Make sure the username is correct.")
    ...
    def test_main_success(self, mock_input, mock_generate):
        """
