...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_scraping_movie_details_success(self, mock_movie_details_scraper):
        ...
        response = self.client.post("/movie_details", json={"film_url": "https://letterboxd.com/film/mickey-17/"})
    ...
    def test_summary_aspects_success(self, mock_get_results, mock_scrape_reviews):
        ...
        response = self.client.post("/summary_aspects", json={"film_url": "https://letterboxd.com/film/mickey-17/"})
        self.assertEqual(response.status_code, 200)
        data = response.get_json()
